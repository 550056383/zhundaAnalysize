...
//    }
    ...
    public static ResultMessage getIntegrityLogicAnalysize(Map<String, Object> resource){
        ...
        int boss=0;
        if(StringUtils.isBlank(rfi)||rfi.equals("N/A")){
            boss=1;
            list.add("YD5-RFI-actualEndDate为空");
        }
        if(StringUtils.isBlank(mos)||mos.equals("N/A")){
            boss=1;
            list.add("YD5-MOS-actualEndDate为空");
        }
        if(StringUtils.isBlank(ic)||ic.equals("N/A")){
            boss=1;
            list.add("YD5-IC-actualEndDate为空");
        }
        if(StringUtils.isBlank(sc)||sc.equals("N/A")){
            boss=1;
