...
public class DynamicPOJO {
    private static String classString = "/* hehha */" + "public class Student{ " + " private String  studentId; " + "public String getStudentId(){ " + "  return \"小明\"; " + " }  " + "}  ";
        String[] strings={"id","name","age","phone","address"};
    private String str=null;

    public DynamicPOJO(String[] strings,String sheetName) {
        this.strings = strings;
        for (String s:strings){
            str="/* hehha */" + "public class "+sheetName+"{ " + " private String  "+s+";}";
        }
    }
